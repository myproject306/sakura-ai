...
os.makedirs('c:/Users/QATAR/Downloads/sakura-ai/icons', exist_ok=True)
...
with open('c:/Users/QATAR/Downloads/sakura-ai/icons/icon.svg', 'w', encoding='utf-8') as f:
    f.write(svg)

print("icon.svg created successfully!")
print("Icons directory:", os.listdir('c:/Users/QATAR/Downloads/sakura-ai/icons'))
